...
Dog.create(breed: 'Blue Heeler/Australian Cattle Dog', 
...
Dog.create(breed: 'Golden Retriever', 
...
Dog.create(breed: 'German Shepard', 
...
Dog.create(breed: 'French Bulldog', 
...
Dog.create(breed: 'Labrador Retriever', 
...
Dog.create(breed: 'Saint Bernard', 
